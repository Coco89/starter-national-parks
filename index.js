//FORM VALIDATION
// It accepts a single string value and returns true if the value isn't null and the string contains at least one non-space character.
...
// it passes the value of each input through the validateExists function then returns a collection of errors messaes for the user to see.
...
//   // Get the name input - One way: directly select one of the <input> elements and use the value property to get data.
//   // const parkName = document.querySelector("#name-input").value;
//   // console.log(parkName);

//   const formData = new FormData(event.target); //a built-in object that can automatically read the data from the form and present it in an easy-to-use interface
